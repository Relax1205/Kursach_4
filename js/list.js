...
Лук очистите и нарежьте мелко.

В кастрюле разогрейте масло и обжарьте лук до прозрачности (около 3-5 минут).

Добавьте морковь и картофель в кастрюлю. Перемешайте.

Залейте овощи водой, доведите до кипения и убавьте огонь.

Варите суп на слабом огне 25-30 минут, пока картофель и морковь не станут мягкими.
...
Общее время: 35-40 минут` },
        { category: 'soup', title: 'Фасолевый суп с картошкой', requiredIngredients: ['beans', 'potato', 'onion', 'oil', 'water'], fullRecipe: `Ингредиенты:
...
Фасоль замочите на несколько часов (или на ночь), затем отварите до готовности (около 40-50 минут).
...
Добавьте картофель в кастрюлю, залейте водой и доведите до кипения.

Когда картофель станет мягким (примерно через 15-20 минут), добавьте отваренную фасоль в кастрюлю.
...
Время варки фасоли: 40-50 минут (если фасоль не была замочена, время варки увеличится)

Время варки супа: 20-30 минут

Общее время: 60-80 минут` },
        { category: 'soup', title: 'Куриный суп с картофелем и морковью', requiredIngredients: ['chicken', 'potato', 'carrot', 'onion', 'oil', 'water'], fullRecipe: `Ингредиенты:
...
Морковь очистите и нарежьте кольцами или полукольцами.

Лук очистите и нарежьте мелко.

В кастрюле разогрейте масло и обжарьте лук до мягкости (3-5 минут).

Добавьте куриное мясо и обжарьте его до золотистой корочки (около 5-7 минут).

Залейте мясо водой, доведите до кипения и варите 10 минут.

Добавьте картофель и морковь, варите 20-25 минут до мягкости овощей.
